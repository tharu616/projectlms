...
<div class="min-h-screen flex flex-col">
    ...
    <section id="courses" class="py-16">
        <div class="container mx-auto px-4">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                <form action="${pageContext.request.contextPath}/home" method="post" class="flex flex-wrap gap-4">
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">Stay updated with the latest news and announcements from our institution.</p>
            </div>
    ...
    <section class="py-16 bg-blue-600 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">Join thousands of students who have already taken the first step towards their future.</p>
            <div class="flex flex-wrap justify-center gap-4">
                <a href="${pageContext.request.contextPath}/register" class="bg-white text-blue-600 hover:bg-blue-100 px-6 py-3 rounded-md font-medium transition">
                    Register Now
                </a>
                <a href="${pageContext.request.contextPath}/contact" class="bg-transparent border border-white text-white hover:bg-white hover:text-blue-600 px-6 py-3 rounded-md font-medium transition">
                    Contact Us
                </a>
            </div>
        </div>
